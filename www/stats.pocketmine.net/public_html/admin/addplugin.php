...
if (isset($_POST['submit'])) {
    ...
    if ($plugin === null) {
        ...
        if ($statement->fetch()) {
            err('Someone already owns this plugin. It may be a duplicate plugin. If you are a secondary developer for this plugin poke shoghicp in IRC.');
            ...
            <div class="row-fluid" style="margin-left: 25%;">
                ...
                <div style="width: 50%;">
                    <p style="font-size:18px; font-weight:200; line-height:27px; text-align: center;">
                        <b>NOTE:</b> Most plugin additions are manually processed (some are automatic). <br/> If you enter an email address you will be notified via email once it has been processed.
                    </p>
