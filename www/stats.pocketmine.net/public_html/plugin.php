...
if (!isset($_GET['plugin'])) {
    $page_title = 'PocketMine :: Invalid Plugin';
				...
				<div class="row-fluid">
					<div class="span12 center" style="text-align: center;">
						<ul class="quick-actions" style="margin: 0;">
							<li>
								<a href="http://api.stats.pocketmine.net/signature/' . $encodedName . '.png" target="_blank">
									<span>Signature image</span>
								</a>
							</li>
							<li>
								<a href="http://api.stats.pocketmine.net/plugin-preview/' . $encodedName . '.png" target="_blank">
