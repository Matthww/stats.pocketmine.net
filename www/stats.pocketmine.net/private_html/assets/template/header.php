...
<head>
    ...
    <!-- css -->
    <link href="http://static.stats.pocketmine.net/css/libraries/bootstrap/bootstrap.min.css" rel="stylesheet"/>
    <link href="http://static.stats.pocketmine.net/css/libraries/font-awesome/font-awesome.min.css" rel="stylesheet"/>
    <link href="http://static.stats.pocketmine.net/css/libraries/template/template.min.css" rel="stylesheet"/>
    <link href="http://static.stats.pocketmine.net/css/libraries/template/template.blue.min.css" rel="stylesheet"/>
    <link href="http://static.stats.pocketmine.net/css/libraries/jquery/typeahead.js-bootstrap.css" rel="stylesheet"/>
    <link href="http://static.stats.pocketmine.net/css/libraries/famfamfam/fam-icons.css" rel="stylesheet"/>
    ...
    <script src="http://static.stats.pocketmine.net/javascript/libraries/jquery/jquery.jpanelmenu.min.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/jquery/jquery.sparkline.min.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/bootstrap/bootstrap.min.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/bootstrap/tooltip.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/bootstrap/typeahead.min.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/template/template.min.js" type="text/javascript"></script>

    <!-- charting -->
    <script src="http://static.stats.pocketmine.net/javascript/libraries/highcharts/highstock.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/highcharts/themes/simplex.js" type="text/javascript"></script>
    <script src="http://static.stats.pocketmine.net/javascript/libraries/highcharts/exporting.js" type="text/javascript"></script>

    <!-- mcstats -->
    <script src="http://static.stats.pocketmine.net/javascript/mcstats.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        _gaq.push(['_setDomainName', 'stats.pocketmine.net']);
...
<body>
<div id="header">
    <h1><a href="/">Statistics / Plugin Metrics</a></h1>
</div>
    ...
    <ul>
        ...
        <li>
            ...
            <ol style="padding: 0; margin: 0;" class="sponsors">
                <li><a href="http://buycraft.net" target="_blank"><img src="http://static.stats.pocketmine.net/img/sponsors/buycraft.png" width="210px" style="padding-left: 10px" /></a></li>
                <li><a href="http://avnk.net" target="_blank"><img src="http://static.stats.pocketmine.net/img/sponsors/Avalanche-Network-v5.png" width="210px" /></a></li>
...
<div id="content">
    <div id="content-header">
        <h1>Statistics / Plugin Metrics</h1>
    </div>
